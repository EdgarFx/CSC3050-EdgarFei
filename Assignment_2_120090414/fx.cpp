...
//         file_name[argv[1]] = ++file_num;
//         file_list[file_num] = mips_file;
//         code_file = fopen(argv[2],"r");
//         file_name[argv[2]] = ++file_num;
//         file_list[file_num] = code_file;
//         checkpoints_file = fopen(argv[3],"r");
//         file_name[argv[3]] = ++file_num;
//         file_list[file_num] = checkpoints_file;
//         in_file = fopen(argv[4],"r");
//         file_name[argv[4]] = ++file_num;
//         file_list[file_num] = in_file;
//         out_file = fopen(argv[5],"w");
//         file_name[argv[5]] = ++file_num;
//         file_list[file_num] = out_file;
...
//         char *pt;
//         pt = MEMORY_START+*REGS[4];
//         for(int i=0;i<*REGS[5],(start_ptr!=NULL)&&(*start_ptr!='\n');i++){
//             *(pt+i) = *start_ptr;
//             start_ptr++;    
//         }
//         *end_ptr = start_ptr;
...
//             return;
//         }
//         if (file_name.count(str)){
//             file_discriptor = file_name[str];
//         }else{
//             file_name[str] = ++file_num;
//             file_discriptor = file_num;
//             file_list[file_discriptor] = file;
//         }
//         *REGS[2] = file_discriptor;
//         return;
//     }else if(*REGS[2]==14){ //read
//         int file_discriptor = *REGS[4];
//         FILE *file = file_list[file_discriptor];
//         char *buffer = *REGS[5] + MEMORY_START;
//         int length = *REGS[6];
//         char *content;
//         fgets(content,length,file);
//         file_list[file_discriptor] = file;
//         *REGS[2] = strlen(content);
...
//         char *buffer = *REGS[5]+MEMORY_START;
//         int num = 0;
//         for(int i=0;i<*REGS[6]&&(buffer+i)!=NULL;i++){
